...
class SpeechExtractorProcessArgument(BaseModel):
    host: str
    port: int
    ...
    def __argparse(cls) -> Namespace:
        ...
        parser.add_argument(
            "--public-bind-port", type=int, default=8002, help="Public bind port"
        )
        parser.add_argument(
            "--redis-host",
            type=str,
    ...
    @classmethod
    def argparse(cls) -> "SpeechExtractorProcessArgument":
